    ...
    <div className="grid grid-col-1 pt-10 w-screen lg:grid-cols-[2fr,1fr] p-10">
      <div className="flex flex-col items-center justify-center w-full text-center">
        <div className="text-center">
          ...
          <p className="mt-2 text-4xl font-bold tracking-wider text-red-400 md:text-5xl lg:text-6xl">
            Server Error
          </p>
          <p className="my-10 text-lg text-gray-500 md:text-xl lg:text-2xl">
            Here are some possible reasons why:
          </p>
          <ul className="mx-auto text-lg text-left text-gray-500 list-disc max-w-fit md:text-xl lg:text-2xl">
            <li>Our hamster-powered servers took a break for a spa day.</li>
            <li>The gremlins that manage our server room decided to party.</li>
            <li>Our servers are on strike demanding better coffee.</li>
            <li>
              We are performing emergency server maintenance (because why not?).
            </li>
            <li>The server room is haunted by ghostly bugs and glitches.</li>
          </ul>
          <p className="my-12 text-lg text-gray-500 md:text-xl lg:text-2xl">
            Do not worry, our team of highly-trained tech wizards is already on
            the case!
          </p>
        </div>
      </div>
