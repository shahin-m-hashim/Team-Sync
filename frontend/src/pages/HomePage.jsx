...
export default function HomePage() {
  return (
    <>
      <NavbarComponent />
      <section className="grid h-full grid-cols-1 gap-x-14 my-10 md:my-auto lg:grid-cols-[2fr,1fr] px-7 md:px-28">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col justify-start gap-10 mt-10 md:flex-row ">
            ...
            <div className="flex items-center justify-center p-5 text-white sm:max-w-full max-w-[32rem] rounded-xl bg-slate-900">
              Revolutionize The Way Your Teams Work Together With Our Intuitive
              Platform. Streamline your teams workflow and communication with an
              intuitive and feature-rich platform that revolutionizes the way
