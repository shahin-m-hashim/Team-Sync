...
export default function ListItem({
  ...
  return (
    <div className="grid my-[1px] border-gray-700 border-b-[1px] grid-cols-[.5fr,.5fr,.5fr,1.5fr,.7fr,.5fr,.5fr,.5fr] w-full py-3 px-7 text-sm">
      <span>{name}</span>
      ...
      <div className="flex items-center">
        <div className="inline-flex text-xs items-center justify-center bg-[#5030E5] size-7 rounded-[50%]">
          {progress}%
        </div>
